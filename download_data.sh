...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXPY_Intro" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "LinkedLists" "MarkovChains" "MatplotlibIntro" "NMF" "NearestNeighbor" "NumpyIntro" "PolynomialInterpolation" "RegularExpressions" "Simplex" "UnixShell2" "Wavelets")
